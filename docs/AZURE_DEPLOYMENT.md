...
- `AZURE_AD_ADMIN_EMAILS` (defaults to `rudi@devforgesolutions.com,tristan@devforgesolutions.com,calvin@devforgesolutions.com,ruds.botha@gmqail.com,ruds.botha@gmail.com,rudsrudibotha@gmail.com`)
